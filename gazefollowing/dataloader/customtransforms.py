...
class RandomHorizontalFlip_GOO(object):
    ...
    def __call__(self, sample):
        ...
        sample = {'img': image, 'bbox': bbox, 'eyes': eyes, 
        'eyes_bbox': eyes_bbox, 'gaze': gaze, 'gtbox': gtbox}

        return sample

class RandomVerticalFlip_GOO(object):
...
class RandomCrop_GOO(object): 
    ...
    def __call__(self, sample):
        ...
        sample = {'img': image, 'bbox': bbox, 'eyes': eyes, 'eyes_bbox': eyes_bbox, 'gaze': gaze, 'gtbox': gtbox}
